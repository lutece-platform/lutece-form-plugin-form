...
INSERT INTO form_entry (id_entry, id_resource, resource_type, id_type, id_parent, title, help_message, comment, mandatory, fields_in_line, pos, id_field_depend, confirm_field, confirm_field_title, field_unique) VALUES (1,1,'FORM_FORM_TYPE',1,2,'Quelle licence préférez vous ?','','',0,0,2,NULL,NULL,NULL,NULL);
INSERT INTO form_entry (id_entry, id_resource, resource_type, id_type, id_parent, title, help_message, comment, mandatory, fields_in_line, pos, id_field_depend, confirm_field, confirm_field_title, field_unique) VALUES (2,1,'FORM_FORM_TYPE',9,NULL,'Qu''attendez vous d''un CMS open-source ?',NULL,NULL,0,0,1,NULL,NULL,NULL,NULL);
INSERT INTO form_entry (id_entry, id_resource, resource_type, id_type, id_parent, title, help_message, comment, mandatory, fields_in_line, pos, id_field_depend, confirm_field, confirm_field_title, field_unique, pos_conditional) VALUES (3,1,'FORM_FORM_TYPE',6,NULL,'Si autre merci de préciser.','','',0,0,0,7,NULL,NULL,NULL,1);
INSERT INTO form_entry (id_entry, id_resource, resource_type, id_type, id_parent, title, help_message, comment, mandatory, fields_in_line, pos, id_field_depend, confirm_field, confirm_field_title, field_unique) VALUES (4,1,'FORM_FORM_TYPE',2,2,'Quel éditeur pour ajouter vos contenus ?','','',0,0,3,NULL,NULL,NULL,NULL);
INSERT INTO form_entry (id_entry, id_resource, resource_type, id_type, id_parent, title, help_message, comment, mandatory, fields_in_line, pos, id_field_depend, confirm_field, confirm_field_title, field_unique) VALUES (5,1,'FORM_FORM_TYPE',5,2,'Quelle accessibilité pour votre CMS ?','','',0,0,4,NULL,NULL,NULL,NULL);
INSERT INTO form_entry (id_entry, id_resource, resource_type, id_type, id_parent, title, help_message, comment, mandatory, fields_in_line, pos, id_field_depend, confirm_field, confirm_field_title, field_unique) VALUES (6,1,'FORM_FORM_TYPE',1,2,'Quelle communauté pour votre CMS ?','','',0,0,5,NULL,NULL,NULL,NULL);
INSERT INTO form_entry (id_entry, id_resource, resource_type, id_type, id_parent, title, help_message, comment, mandatory, fields_in_line, pos, id_field_depend, confirm_field, confirm_field_title, field_unique) VALUES (7,1,'FORM_FORM_TYPE',2,2,'Quelle base de données pour votre CMS ?','','',0,0,6,NULL,NULL,NULL,NULL);
INSERT INTO form_entry (id_entry, id_resource, resource_type, id_type, id_parent, title, help_message, comment, mandatory, fields_in_line, pos, id_field_depend, confirm_field, confirm_field_title, field_unique) VALUES (8,1,'FORM_FORM_TYPE',7,2,'Autre','','',0,0,7,NULL,NULL,NULL,NULL);
