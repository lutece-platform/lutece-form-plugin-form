...
INSERT INTO form_entry (id_entry, id_form, id_type, id_parent, title, help_message, comment, mandatory, fields_in_line, pos, id_field_depend, confirm_field, confirm_field_title, field_unique, pos_conditional) VALUES (3,1,6,NULL,'Si autre merci de préciser.','','',0,0,0,7,NULL,NULL,NULL,1);
...
INSERT INTO form_entry (id_entry, id_form, id_type, id_parent, title, help_message, comment, mandatory, fields_in_line, pos, id_field_depend, confirm_field, confirm_field_title, field_unique) VALUES (8,1,7,2,'Autre','','',0,0,7,NULL,NULL,NULL,NULL);
