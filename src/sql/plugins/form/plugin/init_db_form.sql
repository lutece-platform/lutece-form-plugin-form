...
INSERT INTO form_entry (id_entry, id_form, id_type, id_parent, title, help_message, comment, mandatory, fields_in_line, pos, id_field_depend, confirm_field, confirm_field_title, field_unique) VALUES (3,1,6,NULL,'Si autre merci de préciser.','','',0,0,3,0,NULL,NULL,NULL);
...
INSERT INTO form_entry (id_entry, id_form, id_type, id_parent, title, help_message, comment, mandatory, fields_in_line, pos, id_field_depend, confirm_field, confirm_field_title, field_unique) VALUES (5,1,5,2,'Quelle accessibilité pour votre CMS ?','','',0,0,4,NULL,NULL,NULL,NULL);
INSERT INTO form_entry (id_entry, id_form, id_type, id_parent, title, help_message, comment, mandatory, fields_in_line, pos, id_field_depend, confirm_field, confirm_field_title, field_unique) VALUES (6,1,1,2,'Quelle communauté pour votre CMS ?','','',0,0,5,NULL,NULL,NULL,NULL);
INSERT INTO form_entry (id_entry, id_form, id_type, id_parent, title, help_message, comment, mandatory, fields_in_line, pos, id_field_depend, confirm_field, confirm_field_title, field_unique) VALUES (7,1,2,2,'Quelle base de données pour votre CMS ?','','',0,0,6,NULL,NULL,NULL,NULL);
INSERT INTO form_entry (id_entry, id_form, id_type, id_parent, title, help_message, comment, mandatory, fields_in_line, pos, id_field_depend, confirm_field, confirm_field_title, field_unique, pos_conditional) VALUES (8,1,7,2,'Autre','','',0,0,0,NULL,NULL,NULL,NULL,1);
